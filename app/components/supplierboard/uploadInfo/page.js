...
export default function UploadSupplierInfo() {
    const [formData, setFormData] = useState({
        supplierName: ""
    });
    const [supplierLicence, setSupplierImage] = useState(null);
    ...
    const handleSubmit = async(event) => {
        ...
        formData.append('supplierLicence', supplierLicence);
        formData.append('supplierName', formData.supplierName);

        try {
            const response = await axios.post(`${ApiUrl}/supplier_upload_info`, formData, {
                headers: {
                    ...
                    <Form onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <Form.Group className="mb-4" controlId="formBasicSupplierLicence">
                            ...
                            <Form.Text className="text-muted">
                                Upload a clear image of your supplier certification or license
                            </Form.Text>
                        </Form.Group>
