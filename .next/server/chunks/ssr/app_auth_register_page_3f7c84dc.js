...
function Register() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setLoading(true);
        try {
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$actions$2f$userAuthAction$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userRegister"])(formData));
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=app_auth_register_page_3f7c84dc.js.map